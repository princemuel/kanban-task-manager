import { IconDarkTheme, IconLightTheme } from "@/common";
...
export const ThemeIcon = () => {
  ...
  const Icon = isDarkMode ? IconLightTheme : IconDarkTheme;
...
function ThemeIconFallback() {
  return (
    ...
    >
      <IconLightTheme className="transition duration-200 ease-in-out" />
      <span className="sr-only">Toggle theme</span>
    </button>
  );
}
